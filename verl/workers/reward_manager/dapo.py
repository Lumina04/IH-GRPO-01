...
class DAPOMathRewardManager:
    """
    The Reward Manager is borrowed from https://github.com/PRIME-RL/PRIME
    """

    def __init__(self, tokenizer, num_examine, compute_score=None,max_resp_len=None,overlong_buffer_cfg=None,) -> None:
    ...
    def __call__(self, data: DataProto):
        ...
        data_sources = data.non_tensor_batch["data_source"]
        extra_info_dict["acc"] = list(scores)
        ...
        for i in range(len(data)):
            ...
            if self.overlong_buffer_cfg.enable:
                ...
                if self.overlong_buffer_cfg.log:
                    extra_info_dict["overlong_reward"].append(overlong_reward)
                    extra_info_dict["overlong"].append(overlong_reward < 0)
